...
int     main(void)
{
   ...
   // esta es la dirección de la variable entera n: 0x7ffcd545b2b0 

   ptr = &n2;
   printf ("esta es la dirección de la variable entera n2: %p \n", ptr); 
   // esta es la dirección de la variable entera n2: 0x7ffcd545b2b4 
    
   ptr = &c;
   printf ("esta es la dirección de la variable char c: %p \n", ptr); 
   // esta es la dirección de la variable char c: 0x7ffcd545b2af 
   ...
   // esta es la dirección de la variable prt2 : 0x7ffcd545b2af 
