...
int     main(void)
{
    ...
    // Un puntero es como cualquier otra variable
    // Declaración de un puntero a un int - entero
    int     *ptr;
    int     *ptr2;
    // Declaración de un puntero a un puntero en int
    // ptr3 posee la dirección de un puntero
    int     **ptr3;
   ...
   // esta es la dirección de la variable entera n: 0x7ffde385f0b8 

   ptr = &n2;
   printf ("esta es la dirección de la variable entera n2: %p \n", ptr); 
   // esta es la dirección de la variable entera n2: 0x7ffde385f0bc 
    
   ptr = &c;
   printf ("esta es la dirección de la variable char c: %p \n", ptr); 
   // esta es la dirección de la variable char c: 0x7ffde385f0b7 

   // asignación de prt a ptr2, ptr2 contiene la dirección de la variable char c también
   ptr2 = ptr;
   printf ("esta es la dirección de la variable prt2: %p \n", ptr2); 
   // esta es la dirección de la variable prt2: 0x7ffde385f0b7 

   // asignación de prt a ptr3, ptr3 contiene la dirección de la variable char c también
   ptr3 = ptr;
   printf ("esta es la dirección de la variable prt3: %p \n", ptr3); 
   // esta es la dirección de la variable prt3: 0x7ffde385f0b7 
